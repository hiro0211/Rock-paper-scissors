...
const images = [
  'じゃんけんアプリ/images/グー-removebg-preview.png',
  'じゃんけんアプリ/images/チョキ-removebg-preview.png',
  'じゃんけんアプリ/images/パー-removebg-preview.png'
];
...
const audioWin = new Audio('じゃんけんアプリ/audio/決定ボタンを押す23.mp3');
const audioLose = new Audio('じゃんけんアプリ/audio/間抜け1.mp3');
const audioDraw = new Audio('じゃんけんアプリ/audio/マントを翻す.mp3');
const roulette = new Audio('じゃんけんアプリ/audio/電子ルーレット.mp3');
